...
class ComplianceMapper:
    ...
    def map_requirements_to_compliance(
        ...
        try:
            for requirement in requirements:
                ...
                requirement_mappings = self._map_single_requirement(
                    requirement, compliance_standards
                )
                mappings.extend(requirement_mappings)

            logger.info(
                f"Successfully mapped {len(mappings)} requirements to compliance standards"
            )
            return mappings
    ...
    def _calculate_mapping_confidence(
        self, requirement_text: str, standard: ComplianceStandard
    ) -> float:
